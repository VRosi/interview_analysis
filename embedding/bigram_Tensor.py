...
corpus_file = '/Users/VictorRosi/Documents/GitHub/interview_analysis/corpus/'+word+'.json'
...
model = KeyedVectors.load_word2vec_format('frWiki_no_phrase_no_postag_500_cbow_cut10.bin', binary=True)
